...
def getcmd():
    ...
    CMD_DICT = {
               'start'   :'celery worker -E -A core.service  --pidfile=%s  --logfile=%s -l warning' %( PIDFILE, LOGFILE),
               'show'    :'celery multi show     worker -A core.service  --pidfile=%s  --logfile=%s ' %(PIDFILE, LOGFILE),
