...
class APreProduct(api_resource.ApiResource):
	...
	def get(args):
		...
		return {
			...
			'weight': '0.00' if not pre_product.standard_model else pre_product.standard_model.weight,
			...
			'postage_money': pre_product.unified_postage_money,
	...
	def post(args):
		...
		result = update_product_service.update_product(product_id, {
			'corp': args['corp'],
			'base_info': args['base_info'],
			'models_info': args['models_info'],
			'logistics_info': args['logistics_info'],
