...
class ProductModelGenerator(business_model.Service):
	...
	def __get_all_model_property_info(self, corp_id, is_enable_model_property_info):
		"""
		获取系统中所有的商品规格属性信息
	...
	def fill_models_for_products(self, products, is_enable_model_property_info):
		...
		id2property, id2propertyvalue = self.__get_all_model_property_info(self.corp.id, is_enable_model_property_info)
