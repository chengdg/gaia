...
class EncodeProductService(business_model.Service):
	...
	def get_models_info(self, product):
		...
		if standard_model:
			models_info['standard_model'] = {
				...
				"customized_price": standard_model.customized_price,
		...
		if custom_models:
			for custom_model in custom_models:
				models_info['custom_models'].append({
					...
					"customized_price": custom_model.customized_price,
	...
	def get_cps_promotion_info(self, product):
		...
		if cps_promotion_info:
			data = {
				'cps_gross_profit': cps_promotion_info.get('cps_gross_profit', 0),
				'cps_gross_profit_rate': cps_promotion_info.get('cps_gross_profit_rate', 0),
