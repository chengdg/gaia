...
class IntegralStrategy(business_model.Model):
	...
	def update(self, update_params):
		...
		member_models.IntegralStrategySettings.update(
			...
			click_shared_url_increase_count = update_params.get('click_shared_url_increase_count',0),
			...
			buy_via_shared_url_increase_count_for_author = update_params.get('buy_via_shared_url_increase_count_for_author',0),
