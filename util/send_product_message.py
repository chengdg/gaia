...
#
# from settings import PRODUCT_TOPIC_NAME
# from settings import PRODUCT_MSG_NAME
...
def send_reject_product_ding_message(data):
	"""
	发送商品驳回的ding talk 消息
	{	 u'客户来源': customerFrom,
	...
	content = u'\n'.join([u':'.join(item) for item in data.items()])
